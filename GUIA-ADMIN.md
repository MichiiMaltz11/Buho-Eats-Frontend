...
- ⏳ Ver lista de reseñas reportadas
- ⏳ Botón "Aprobar" (mantener reseña)
- ⏳ Botón "Eliminar" (sin strike)
- ⏳ Botón "Eliminar + Strike" (con penalización)
- ⏳ Marcar reporte como "resuelto"

**👥 Gestión de Usuarios:**
- ⏳ Tabla de usuarios con filtros
- ⏳ Ver strikes de cada usuario (0/3, 1/3, 2/3, 3/3)
- ⏳ Auto-ban al llegar a 3 strikes
...
- ⏳ Card de total reseñas
- ⏳ Card de reportes pendientes (con badge)
